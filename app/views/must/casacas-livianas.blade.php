...
<div class="row">
	<div class="col-sm-2">
		...
		<div class="row">
			<div class="col-sm-2">
				<img src="{{url()}}/images/casacas-livianas/space-2.jpg" alt="" class="center-block img-responsive space-must">
	...
	<div class="col-sm-1">
		<img src="{{url()}}/images/casacas-livianas/space-1.jpg" alt="" class="center-block img-responsive space-must">
